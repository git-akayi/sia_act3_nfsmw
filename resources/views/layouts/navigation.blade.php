        ...
        <div class="flex justify-between h-20">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('race.index')" :active="request()->routeIs('race.*')"
                        class="uppercase tracking-widest font-black italic text-gray-300 hover:text-red-500 transition">
                        {{ __('Race') }}
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <div class="px-4 py-2 bg-zinc-950 border border-green-900 rounded-md">
                    <span class="text-green-500 font-black font-mono tracking-widest uppercase italic">
                        CASH: ${{ number_format(Auth::user()->cash) }}
                    </span>
                </div>
